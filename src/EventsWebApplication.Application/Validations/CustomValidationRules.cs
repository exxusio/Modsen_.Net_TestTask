...
namespace EventsWebApplication.Application.Validations
{
    public static class CustomValidationRules
    {
        ...
        public static IRuleBuilder<T, DateTime> EventDateAndRegistrationDate<T>(this IRuleBuilder<T, DateTime> ruleBuilder, Func<T, DateTime> getEventDate)
        {
            return ruleBuilder
                .NotNull().WithMessage("{PropertyName} should not be null")
                .GreaterThan(DateTime.MinValue).WithMessage("{PropertyName} should be a valid date")
